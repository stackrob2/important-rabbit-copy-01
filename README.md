...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://352720b2747e.ngrok.io/pull/5fffdd479486aa02f2385efd
...
To start editing your site, you can use the Sanity interface at https://important-rabbit-fdd47.sanity.studio/.
...
Generated at `2021-01-14T05:57:49.972Z` by Stackbit version `0.3.42`.